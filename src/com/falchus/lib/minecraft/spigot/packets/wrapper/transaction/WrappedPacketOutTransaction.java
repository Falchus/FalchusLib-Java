...
public class WrappedPacketOutTransaction extends PacketTransactionWrapper {
	
	private static final Set<String> names = Set.of(
		version.getPackageNms() + "PacketPlayOutTransaction",
		networkProtocolGame + "ClientboundPingPacket",
		networkProtocolCommon + "ClientboundPingPacket"
	);

	private WrappedPacketOutTransaction(@NonNull Object handle) {
		super(handle, names);
	}
	
	@SuppressWarnings("unchecked")
	public WrappedPacketOutTransaction(int id) {
