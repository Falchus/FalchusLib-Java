...
public class VersionAdapter implements IVersionAdapter {
    ...
    @Getter
    String packageOb = "org.bukkit.";
    @Getter
    String packageObc = packageOb + "craftbukkit.";
    @Getter
    String packageNm = "net.minecraft.";
    @Getter
    String packageNms = packageNm + "server.";
    ...
    @Getter
    Field playerConnection_networkManager;
    Class<?> networkManager;
    @Getter
    Field networkManager_channel;
    @Getter
